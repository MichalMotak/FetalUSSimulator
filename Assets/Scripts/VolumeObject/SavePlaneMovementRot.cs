...
namespace UnityVolumeRendering
{
	...
	{		
		...
		private string filePath = "AcquiredData/Poses1_rot_all/rot_unity.csv";
		private string imagePath = "AcquiredData";

		// Phantom data, Poses1_rot
...
//		private int screenshotIndex = 20699; // 23 w train
		...
		// Poses1_rot_all
		private float initial_x = 0f, initial_y = 0f, initial_z = 0f;
		private float final_x = 90f, final_y = 90f, final_z = 90f;
		private float update_x = 6f, update_y = 6f, update_z = 6f;
...
//                        Vector3 temppos = new Vector3(0.01544668f, 0.01682039f, -0.00000000284f); // 25 w
                    ...
                    //    Vector3 temppos = new Vector3(0.01602831f, -0.04997408f, 0.02329378f); // 24 w
						...
						Debug.Log($" idx_x {idx_x} , idx_y {idx_y} , idx_z {idx_z}");
