...
//     public class RpcRot : JsonRpcService {

//         SlicingPlane plane;
//         SavePlaneMovementRot saveplanemovepos;


//         public RpcRot(SlicingPlane plane, SavePlaneMovementRot saveplanemovepos){
//             this.plane = plane;
...
//         public static RpcRot rpc { get; private set; }
...
//             rpc = new RpcRot(slicingPlane, saveplanemovepos);
...
//         void OnEnable()
//         {
//             SavePlaneMovementRot.OnFunctionBrot += ExecuteFunctionB;
//         }
